...
class _CreateRequestScreenState extends ConsumerState<CreateRequestScreen> {
  ...
  void _showSnackBar(String message, Color color) {
    AppServices.showSnackBar(context, message, color); // ✅ CORREGIDO
  }
      ...
      try {
        ...
        if (userDoc.exists) {
          ...
          if (data != null) {
            ...
            _dobDisplayController.text = data['fecha_nacimiento'] ?? '';
  ...
  Future<void> _createRequest() async {
    ...
    try {
      ...
      final requestDataToSave = {
        ...
        'nombre': _nameDisplayController.text.trim(),
        'avatar': _userAvatarUrl ?? "assets/default_avatar.png",
        ...
        'provincia': _userProvinceName ?? 'San Juan',
        'country': _userCountryName ?? 'Argentina',
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Videos (${_selectedVideos.length}/3 - Max 20 MB cada uno)',
                          style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(height: 8),
                        Wrap(
                        ...
                        Container(
                          ...
                          child: const Text('Espacio Publicitario', style: TextStyle(color: Colors.white70)),
                        ),
